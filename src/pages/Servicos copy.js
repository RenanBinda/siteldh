...
export default function Servicos() {
  ...
  const areasAtuacao = [
    {
      id: 1,
      titulo: "Experiência do Usuário (UX)",
      icone: <FaUniversalAccess className="text-primary" size={40} />,
      descricao: "Projetos centrados na diversidade humana, com foco em acessibilidade e interação significativa entre pessoas e tecnologias.",
      entregaveis: [
      ...
      beneficios: [
        "Aumento de engajamento e satisfação",
        "Melhoria na experiência de uso",
        "Maior eficiência na realização de tarefas"
      ],
      cta: {
    ...
    },
    {
      ...
      descricao: "Soluções para sistematizar e estruturar informações, promovendo a inovação e a eficiência nos processos criativos e organizacionais.",
      entregaveis: [
        "Mapeamento e organização de processos criativos",
        "Desenvolvimento de repositórios e acervos digitais",
        "Estratégias de preservação do conhecimento",
        "Indicadores para gestão de design"
      ],
      beneficios: [
    ...
    },
    {
      ...
      descricao: "Capacitação profissional e desenvolvimento de competências em design, acessibilidade digital e metodologias criativas.",
      entregaveis: [
        "Cursos, oficinas e workshops",
        "Mentorias personalizadas",
        "Formação em acessibilidade digital",
        "Desenvolvimento de recursos educacionais digitais"
      ],
      beneficios: [
        "Equipes capacitadas em metodologias atuais",
        "Promoção de uma cultura de design para inovação",
  ...
  const solucoes = [
    {
      titulo: "Treinamentos e Consultorias",
      itens: [
        "Capacitação em design e acessibilidade digital",
        "Consultoria especializada para projetos específicos",
        "Workshops práticos para equipes"
      ]
    },
    {
      ...
      itens: [
        ...
        "Aplicativos e interfaces digitais",
        "Websites institucionais e plataformas"
      ]
    },
    {
      titulo: "Design Estratégico",
      itens: [
        "Modelagem de serviços e experiências multicanal",
        "Sistemas de identidade visual (branding)",
        "Design para inclusão e diversidade"
      ]
    },
    {
      ...
      itens: [
        ...
        "Design de apresentações e materiais institucionais"
      ]
    }
  ];
  ...
  const EspecialidadesSection = ({ areas }) => {
    return (
      <section className="especialidades-section section" aria-labelledby="especialidades-heading">
        <div className="container">
          <div className="section-header">
            <h2 id="especialidades-heading">Nossas <span className="text-primary">Especialidades</span></h2>
            <p>Na LeFul Design House, unimos estratégia, criatividade e inclusão para transformar ideias em experiências significativas.</p>
          </div>
              ...
              >
                ...
                <div className="card-body">
                  ...
                  <div className="feature-group">
                    <h5>O que entregamos:</h5>
                    <ul>
                      {area.entregaveis.map((item, i) => (
                        <li key={`entregavel-${i}`}>{item}</li>
                      ))}
                    </ul>
                  </div>
                  ...
                  <div className="feature-group">
                    <h5>Benefícios:</h5>
                    <ul>
                      {area.beneficios.map((item, i) => (
                        <li key={`beneficio-${i}`}>{item}</li>
                      ))}
                    </ul>
                  </div>
  ...
  const SolucoesSection = () => {
    return (
      <section className="solucoes-section section" aria-labelledby="solucoes-heading">
        <div className="container">
          <div className="section-header">
            <h2 id="solucoes-heading">Soluções <span className="text-primary">Personalizadas</span></h2>
            <p className="lead">Além das especialidades acima, oferecemos projetos sob medida para diferentes contextos e necessidades.</p>
          </div>
            ...
            {solucoes.map((solucao, index) => (
              <div key={index} className="solucao-item">
                <div className="solucao-icon">
                  {/* Adicione um ícone correspondente aqui se desejar */}
                </div>
